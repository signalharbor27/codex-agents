...
11. When no decision or factual prerequisite remains, briefly summarize settled decisions, material rejected alternatives, verification expectations, and remaining assumptions. Ask for confirmation only if the summary introduces an unresolved inference or ambiguity. End a standalone interview here. If a primary skill loaded this procedure during already-authorized work, return to it and proceed under that authority. Settled discussion alone does not authorize implementation.
