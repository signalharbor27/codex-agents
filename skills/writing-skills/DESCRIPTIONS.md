Read this reference when routing clarity is the main problem.
...
- a context pointer is a short phrase that tells the agent when to load deeper material; sharpen it before inlining an entire reference

Weak descriptions:
- summarize the entire workflow
- say the skill is for "any" task in a broad category
- omit what should route somewhere else
- place examples, edge cases, or implementation notes in the description
