...
2. Keep small or tightly coupled scope local. Delegate material independent subsystem or test-layer questions to the minimum useful set of read-only subagents, each with the pinned scope. The main agent owns synthesis and decisions.
